...
- **忠實於逐字稿**，不要補充原文沒有講到的內容。
- 逐字稿來自即時語音辨識，可能有斷句錯誤或錯字。請依上下文推斷出最合理的語意直接寫進筆記，
  不要照抄明顯的辨識錯誤，也不要另闢段落討論哪裡可能聽錯 ——
  讀者手上沒有錄音檔，看到「這裡可能有誤」只會困惑，幫不上忙。
- 真的推不出來的片段就略過不寫，寧可少寫也不要編。
- 只輸出筆記本身，不要在開頭或結尾加上說明文字。`;
